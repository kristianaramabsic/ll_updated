"""
Django settings for labzlink project.
...
SECRET_KEY = 'vhv14m=nxt+y+s=681b288rh+)o=brk@@+oj^x*x5tv0#7jg8a'
...
WSGI_APPLICATION = 'labzlink.wsgi.application'
